...
editorConfig.setMainLanguageId('robot-dsl');       
...
const parseAndValidate = (async () => {
    ...
    if(errors.length > 0){
        ...
        errors.forEach((error) => {
            ...
            errorModal.getElementsByClassName("modal-body")[0].appendChild(errorDiv);
        });
    } else {
        const ValidatedModal = document.getElementById("validModal");
        ValidatedModal.style.display = "block";
    }

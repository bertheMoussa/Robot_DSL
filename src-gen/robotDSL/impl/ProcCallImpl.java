 ...
 * </p>
 * <ul>
 *   <li>{@link robotDSL.impl.ProcCallImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcCallImpl extends ExpressionImpl implements ProcCall {
	...
	protected EClass eStaticClass() {
		return RobotDSLPackage.Literals.PROC_CALL;
	}
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<Expression>(Expression.class, this,
					RobotDSLPackage.PROC_CALL__EXPRESSION);
		}
		return expression;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RobotDSLPackage.PROC_CALL__EXPRESSION:
